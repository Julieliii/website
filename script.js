...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const cardData = [
    {
      ...
      videos: [{ name: "Gameplay Trailer", path: "medias/work1.mp4" }]
    },
    {
      title: "WorkZen",
      title_cn: "",
      ...
      pdfs: [{ name: "Artistic Statement", path: "medias/work2.pdf" }],
      videos: [{ name: "Sculpture Showcase", path: "medias/work2.mp4" }]
    },
    {
      title: "Know your Gut",
      title_cn: "了解你的肠道",
      ...
      pdfs: [{ name: "Installation Guide", path: "medias/work3.pdf" }],
      videos: [{ name: "Experience Demo", path: "medias/work3.mp4" }]
    },
    {
      title: "Catopia",
      title_cn: "",
      ...
      pdfs: [{ name: "Project Document", path: "medias/work4.pdf" }]
    },
    {
      ...
      pdfs: [{ name: "Project Document", path: "medias/work5.pdf" }]
    },
    {
      ...
      pdfs: [{ name: "Project Document", path: "medias/work6.pdf" }],
      videos: [{ name: "Project Video", path: "medias/work6.mp4" }]
    },
    {
      title: "V-cuisine",
      title_cn: "",
      ...
      pdfs: [{ name: "Project Document", path: "medias/work7.pdf" }]
    },
    {
      ...
      pdfs: [{ name: "Project Document", path: "medias/work8.pdf" }]
    },
    {
      title: "Radiate",
      title_cn: "",
      ...
      pdfs: [{ name: "Project Document", path: "medias/work9.pdf" }]
    },
    {
      ...
      pdfs: [{ name: "Project Document", path: "medias/work10.pdf" }],
      videos: [{ name: "Project Video", path: "medias/work10.mp4" }]
    },
    {
      title: "Flushbound",
      title_cn: "",
      ...
      videos: [{ name: "Project Video", path: "medias/work11.mp4" }],
      pdfs: [{ name: "Project Document", path: "medias/work11.pdf" }]
    }
  ];
  ...
  function setupResourceTabs(pdfs, videos) {
    ...
    pdfTab.innerHTML = `<span class="button-content">${pdfText}</span>`;
    ...
    videoTab.innerHTML = `<span class="button-content">${videoText}</span>`;
