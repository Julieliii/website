...
document.addEventListener('DOMContentLoaded', function() {
  ...
  navLinks.forEach(link => {
    link.addEventListener('click', function(e) {
      ...
      const targetSection = targetElement?.classList.contains('page-section')
        ? targetElement
        : targetElement?.closest('.page-section');
  ...
  const cardData = [
    ...
    },
    {
      ...
      image: "public/images/work10.png",
      pdfs: [{ 
        name: "Project Document", 
    ...
    },
    {
      ...
      image: "public/images/work11.png",
      videos: [{ 
        name: "Project Video", 
  ...
  function positionCards() {
    const positions = [
      { x: -300, y: -76, z: -260 }, { x: -240, y: -61, z: -208 },
      { x: -180, y: -46, z: -156 }, { x: -120, y: -31, z: -104 },
      { x: -60, y: -16, z: -52 }, { x: 0, y: 0, z: 0 },
      { x: 60, y: 16, z: 52 }, { x: 120, y: 31, z: 104 },
      { x: 180, y: 46, z: 156 }, { x: 240, y: 61, z: 208 },
      { x: 300, y: 76, z: 260 }
    ];
  ...
  if (selectedWorks) {
    document.body.classList.remove('works-in-view');
    const worksObserver = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        document.body.classList.toggle('works-in-view', entry.isIntersecting);
      });
    }, { threshold: 0.28, rootMargin: '0px 0px -28% 0px' });
    worksObserver.observe(selectedWorks);
  }
